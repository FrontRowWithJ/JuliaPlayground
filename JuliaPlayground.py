...
class JuliaPlayground:
    ...
    def mandelbrot(self):
        ...
        return Julia.gen_mandelbrot(self.width, self.height, self.xmin_mandel, self.xmax_mandel, self.ymin_mandel, self.ymax_mandel, self.zExponent, self.niter, self.bound)

    def _julia(self):
        return Julia.gen_julia_set(self.width, self.height, self.cx, self.cy, self.xmin_julia, self.xmax_julia, self.ymin_julia, self.ymax_julia, self.zExponent, self.niter, self.bound)
    ...
    def update_zExponent(self, zExponent):
        ...
        self.zExponent = zExponent
        return [self.mandelbrot(), self._julia()]
